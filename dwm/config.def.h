...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_gray2,  gruv_blue  },
};
...
static Key keys[] = {
	...
	{ 0, 				XF86XK_AudioMute,		spawn,     	SHCMD("amixer -q sset Master toggle; kill -37 $(pidof dwmblocks)") },
	{ 0, 				XF86XK_AudioLowerVolume,	spawn,     	SHCMD("amixer -q sset Master 3%-; kill -37 $(pidof dwmblocks)") },
	{ 0, 				XF86XK_AudioRaiseVolume,	spawn,     	SHCMD("amixer -q sset Master 3%+; kill -37 $(pidof dwmblocks)") },
